...
describe("PostCard", () => {
  ...
  it("shows edit form on Edit click", async () => {
    renderWithProviders(<PostCard post={mockPost} />);
    await userEvent.click(screen.getByLabelText("Post options"));
  ...
  it("cancels editing and returns to content", async () => {
    renderWithProviders(<PostCard post={mockPost} />);
    await userEvent.click(screen.getByLabelText("Post options"));
    await userEvent.click(screen.getByText("Edit"));
  ...
  it("shows comment section with view comments button", () => {
    renderWithProviders(<PostCard post={mockPost} />);
    expect(screen.getByText("View 2 comments")).toBeInTheDocument();
  });

  it("shows inline comment form when no comments", () => {
    const post = { ...mockPost, comment_count: 0 };
    renderWithProviders(<PostCard post={post} />);
